...
<div class="min-h-screen flex bg-gray-100">
    <div class="fixed py-16 bg-white navigation">
        @include('layouts.navigation')
    </div>
    <div class="w-full pl-40">
        @if (isset($header))
            <header class="bg-orange-300 shadow pl-6 py-16 ">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 text-white lg:px-8 py-12">
                    {{ $header }}
                </div>
            </header>
        @endif
