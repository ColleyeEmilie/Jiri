...
@php
    $classes = ($active ?? false)
                ? 'inline-flex p-6 px-6 items-center text-sm font-medium leading-5 bg-orange-300 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out bg-yellow'
